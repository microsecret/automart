...
| Freshness/removal | source refresh route | `auction-source-freshness.ts`, listing status fields |
...
flowchart TD
  ...
  Discover --> Detail["Fetch public detail page"]
  ...
  Schedule --> Refresh["Refresh oldest checked active listings"]
