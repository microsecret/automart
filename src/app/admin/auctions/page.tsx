    ...
    <Paper radius="md" p="md" withBorder className="admin-auction-inquiry-row">
      <Group gap="md" align="flex-start" wrap="wrap">
        ...
        <Stack gap={6} style={{ flex: "1 1 380px", minWidth: 0 }}>
          ...
          <Group gap="md" wrap="wrap"><Group gap={6}><IconUserCheck size={14} color="#64748b" /><Text size="sm" fw={700}>{inquiry.name}</Text></Group>{inquiry.city && <Group gap={6}><IconMapPin size={14} color="#64748b" /><Text size="sm" c="dimmed">{inquiry.city}</Text></Group>}<Badge size="xs" variant="light" color={inquiry.requesterId ? "teal" : "orange"}>{inquiry.requesterId ? "Аккаунт подтверждён" : "Гостевая заявка"}</Badge></Group>
