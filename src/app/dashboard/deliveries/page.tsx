  ...
  return (
    <Box p={{ base: "sm", md: "md" }}>
      <Stack gap="md">
        <Paper radius="xl" p={{ base: "lg", md: 36 }} style={{ color: "white", overflow: "hidden", position: "relative", isolation: "isolate", background: "radial-gradient(circle at 88% 14%, rgba(59,130,246,.35), transparent 32%), linear-gradient(126deg, #0b1426 0%, #13233f 60%, #1b3a7a 100%)", boxShadow: "0 24px 60px rgba(25, 48, 103, .22)" }}>
          ...
          <Group justify="space-between" align="flex-start" wrap="wrap" gap="lg">
            <Stack gap="xs" maw={650}>
              ...
              <Title order={1} size="h3" c="white" lh={1.1} lts="-.025em" ff="var(--font-display), sans-serif">Маршрут, документы и статусы — в одном кабинете</Title>
            ...
            <Button onClick={() => setOpened(true)} color="white" c="indigo" leftSection={<IconPlus size={17} />} size="md">Рассчитать доставку</Button>
          </Group>
        </Paper>
                    ...
                    return (
                      <Paper key={offer.id} withBorder radius="md" p="md">
                        <Stack gap="sm">
                          ...
                          <Button onClick={() => acceptAuctionOffer(offer.id)} loading={acceptingOfferId === offer.id} disabled={Boolean(acceptingOfferId)} rightSection={<IconArrowRight size={16} />}>Принять в работу</Button>
                        </Stack>
                      </Paper>
                    )
                  })}
        ...
        <Paper withBorder radius="xl" p={{ base: "md", md: "lg" }} style={{ background: "linear-gradient(135deg, rgba(37,99,235,.055), rgba(20,184,166,.045))" }}>
            ...
            <Box className="partner-application-hero">
              <Group justify="space-between" align="flex-start" gap="lg" wrap="wrap">
                <Group gap="md" wrap="nowrap" align="flex-start" maw={590}>
                  ...
                  <Stack gap={6}>
                    <Title order={2} fz={{ base: "22px", sm: "26px" }} lh={1.08}>Получайте заявки в своей географии</Title>
