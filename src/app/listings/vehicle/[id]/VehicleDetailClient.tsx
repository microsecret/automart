            ...
            <Card withBorder radius="md" p="lg" className="vehicle-detail-feature-card vehicle-detail-feature-card--deal">
              <Group gap="md" align="flex-start">
                ...
                <Stack gap={6} style={{ flex: 1 }}>
                  ...
                  <Group gap={6} mt={4}>
                    <IconCheck size={14} color="var(--market-primary)" />
                    <Text size="xs" c="var(--market-primary)">Проверка данных объявления</Text>
                  </Group>
                  <Group gap={6}>
                    <IconCheck size={14} color="var(--market-primary)" />
                    <Text size="xs" c="var(--market-primary)">Проверка документов</Text>
                  </Group>
                  <Group gap={6}>
                    <IconCheck size={14} color="var(--market-primary)" />
                    <Text size="xs" c="var(--market-primary)">Статусы и поддержка</Text>
                  </Group>
                </Stack>
