...
import { processRegistrationReminders } from "@/lib/telegram-registration-reminder"
...
export async function POST(request: NextRequest) {
  ...
  try {
    return NextResponse.json(await processRegistrationReminders())
  } catch (error) {
    console.error("Registration reminders failed:", error)
