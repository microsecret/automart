    ...
    <Box className="service-page" p={{ base: "sm", md: "md" }}>
      <Stack gap="lg">
        ...
        <Alert color="yellow" variant="light" radius="lg" icon={<IconAlertCircle size={18} />}>
          <Text size="sm" maw="var(--measure)">Материалы — информационная основа для подготовки сделки, а не юридическая консультация. Перед подписанием сверяйте актуальные требования, обстоятельства сделки и при необходимости обращайтесь к юристу.</Text>
        </Alert>
      </Stack>
    </Box>
  )
