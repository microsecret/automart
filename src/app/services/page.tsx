...
import { IconBrain, IconChartBar, IconFileSearch, IconGasStation, IconMapPin, IconShieldCheck } from "@tabler/icons-react"
...
const SERVICES = [
  ...
  { href: "/services/fuel-map", title: "Карта АЗС", description: "Точки заправок в крупных городах России.", icon: IconGasStation, color: "orange" },
]
