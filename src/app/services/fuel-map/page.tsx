  ...
  return (
    <Box className="service-page service-page--fuel-map">
      ...
      <Box className="fuel-map-shell">
        {/* Заголовок страницы — для поисковика и чтения с экрана.
         *
         * На странице не было h1 вовсе: иерархия начиналась со второго
         * уровня в подвале, и для поиска страница оставалась безымянной.
         * Видимым его сделать нельзя — он загородил бы карту, которая и
         * есть содержимое страницы.
         *
         * Город в заголовке живой: «Заправки в Уфе» отвечает на запрос
         * точнее, чем общее «Карта АЗС». */}
        <h1 className="visually-hidden">
          {areaLabel ? `Цены на заправках: ${areaLabel}` : "Карта заправок России: цены на топливо"}
        </h1>
        <FuelStationMap
          city={areaLabel}
