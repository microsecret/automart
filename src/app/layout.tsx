...
export const viewport: Viewport = {
  ...
  initialScale: 1,
  viewportFit: "cover",
  /* Цвет строки браузера на телефоне.
   *
   * Без него Android рисует над сайтом серую полосу, а iOS — белую, и
   * сверху появляется чужая граница поперёк страницы. В манифесте цвет
   * уже был задан, но манифест читают только установленные приложения:
   * человеку, открывшему сайт обычной ссылкой, он не достаётся.
   *
   * Два значения по теме устройства: цвет должен совпадать с фоном
   * страницы, иначе вместо продолжения экрана получается шов. Светлый
   * тон — тот же, что у фона сайта, тёмный — подложка ночной темы. */
  themeColor: [
