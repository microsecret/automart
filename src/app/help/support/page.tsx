  ...
  return (
    <Box p={{ base: "sm", md: "md" }} style={{ maxWidth: 600, margin: "0 auto" }}>
      <Stack gap="md">
        ...
        <Text size="sm" c="#71717a">Мы готовы помочь вам 24/7</Text>
        ...
        <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="sm">
          <Card withBorder radius="md" p="md" style={{ borderColor: "#f4f4f5" }}>
            <Stack gap="sm" align="center" ta="center">
              ...
              <Text size="xs" c="#71717a">Нажмите кнопку поддержки в правом нижнем углу</Text>
          ...
          <Card withBorder radius="md" p="md" style={{ borderColor: "#f4f4f5" }}>
            <Stack gap="sm" align="center" ta="center">
              ...
              <Text size="xs" c="#71717a">support@avtorynok.ru</Text>
              <Text size="xs" c="#a1a1aa">Ответ в течение 24 часов</Text>
            </Stack>
          </Card>
        </SimpleGrid>
        ...
        <Card withBorder radius="md" p="md" style={{ borderColor: "#f4f4f5" }}>
          <Group gap="sm">
            ...
            <Stack gap={0}>
              ...
              <Text size="xs" c="#71717a">Онлайн-чат: круглосуточно · Email: Пн-Пт 9:00-21:00</Text>
            </Stack>
          </Group>
        </Card>
      </Stack>
