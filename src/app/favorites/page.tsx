        ...
        <Group justify="space-between" align="center">
          <Stack gap={0}>
            <Group gap="sm" align="center">
              ...
              <Text component="h1" fw={800} fz={22} c="#18181b" ff="var(--font-display),sans-serif">Избранное</Text>
            </Group>
            {data && <Text size="xs" c="#71717a">{data.pagination.total} объявлений в избранном</Text>}
          </Stack>
          {favorites.length > 0 && (
            ...
            <Center>
              <Stack align="center" gap="md">
                ...
                <Stack gap={0} align="center">
                  <Text fw={600} fz="lg" c="#18181b">В избранном пусто</Text>
                  <Text size="sm" c="#71717a" ta="center">Нажимайте на ♥ в карточках объявлений, чтобы сохранить их здесь</Text>
                </Stack>
