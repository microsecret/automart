        ...
        <Box>
          ...
          <Text c="dimmed" mt={6} maw={720}>
            {/* Обещание совпадает с тем, что человек видит ниже.
                ...
                Здесь стояло «Цена указана под ключ», а карточкой ниже —
                «Лот с комиссией от», и весь остальной раздел честно пишет
                «без пошлины и доставки». Разница доходит до миллиона рублей,
                и человек, пришедший из поиска именно на эту страницу, читал
                заголовок как «эти цифры итоговые».

                Ту же ошибку уже поправили в общем разделе аукционов —
                формулировка взята оттуда. */}
            В каталоге {landing.total} автомобилей {landing.makeLabel} с проверенных площадок {landing.countryGenitive}.
            В списке — цена лота с комиссией в рублях по курсу ЦБ; пошлина, утильсбор
            и доставка до вашего города считаются в карточке машины.
          </Text>
        </Box>
