...
const RELAYED_IMAGE_HOSTS = new Set([
  ...
  // beforward помечает снимки как binary/octet-stream: файл настоящий и
  ...
  // Японии оставались без фотографий — а по фотографии машину и выбирают.
  // Релей определяет тип по содержимому файла и отдаёт его правильным.
