...
export const AUCTION_SOURCE_OPTIONS = [
  ...
  { value: "BOBAEDREAM", label: "Bobaedream (Корея)" },
  ...
  { value: "AUTOSALE", label: "AutoSale (Европа)" },
  { value: "GOONET", label: "Goo-net Exchange (Япония)" },
  { value: "BEFORWARD", label: "BE FORWARD (Япония)" },
  { value: "CARSENSOR", label: "CarSensor (Япония)" },
  { value: "IAUTOS", label: "Iautos (Китай)" },
  { value: "YOUXINPAI", label: "YouXinPai (Китай)" },
...
export const AUCTION_SOURCE_PIPELINES: Record<string, { pipeline: AuctionSourcePipeline; label: string }> = {
  ...
  BOBAEDREAM: { pipeline: "PUBLIC_COLLECTOR", label: "Штатный публичный каталог" },
  ...
  AUTOSALE: { pipeline: "PUBLIC_COLLECTOR", label: "Штатный публичный каталог" },
  GOONET: { pipeline: "PUBLIC_COLLECTOR", label: "Штатный публичный каталог" },
  BEFORWARD: { pipeline: "PUBLIC_COLLECTOR", label: "Штатный публичный каталог" },
  CARSENSOR: { pipeline: "PUBLIC_COLLECTOR", label: "Штатный публичный каталог" },
  IAUTOS: { pipeline: "PUBLIC_COLLECTOR", label: "Штатный публичный каталог" },
  YOUXINPAI: { pipeline: "PUBLIC_COLLECTOR", label: "Штатный публичный каталог" },
