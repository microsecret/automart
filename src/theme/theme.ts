...
/* Зелёная шкала темы — по макету площадки.
   ...
   #15803d: белый текст на нём даёт 5,02 при норме 4,5. Соседняя [5]
   #22c55e дала бы 2,28 — надписи на кнопках читались бы плохо. */
const indigo: MantineColorsTuple = [
  "#f0fdf4", "#dcfce7", "#bbf7d0", "#86efac", "#4ade80",
  "#22c55e", "#15803d", "#166534", "#14532d", "#0f3d22",
]
