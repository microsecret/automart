...
export default function AppShellLayout({ children }: { children: React.ReactNode }) {
  ...
  const isFullWidthRoute = Boolean(
    ...
    /* Витрины идут во всю ширину — карточка товара и страница лота.

       Раньше сюда же входили главная, каталог, поиск и аукционы: меню
       занимало 236 пикселей там, где человек смотрит товар, и казалось,
       что оно только отодвигает карточки.

       Теперь у этих страниц три колонки — меню слева, сводка справа,
       товар в центре. Ширина уходит не в поля по краям, а в данные:
       слева навигация со счётчиками и направления, справа новости,
       свежие лоты и курсы. Так устроена площадка, взятая за образец, и
       этим сайт отличается от Дрома с Авто.ру, где обе стороны экрана
       пустуют.

       Во всю ширину остаются только страницы одного товара: там нужны
       фотографии и характеристики, а предложение уйти в «Мото» работает
       против сделки. */
