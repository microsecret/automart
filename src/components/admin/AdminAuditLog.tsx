        ...
        <Group gap="sm" align="flex-start" className={classes.heading}>
          ...
          <Stack gap={2} className={classes.headingCopy}>
            ...
            <Text size="xs" c="dimmed">
              {/* Пояс назван тот, в котором время и показывается.

                  Подпись говорила «по Екатеринбургу», а formatAdminDateTime
                  форматирует по Москве — расхождение в два часа. Разбирая
                  спорное действие, модератор сверял время не с тем поясом. */}
              Неизменяемая история решений: инициатор, раздел и результат. Время указано по Москве.
            </Text>
          </Stack>
        </Group>
