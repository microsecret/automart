    ...
    >
      ...
      <g className="lewheel-mark__wing">
        ...
        <path
          ...
          d="M34 10.4 C24 7.8 12 9.6 1 16 C-2.4 18 -3 20.8 0.6 22 C4.4 23.2 9 21.8 13.6 20.6 C20 18.9 26.4 18.2 32.4 19.4 C34 19.7 34.8 18.6 34.8 16.4 C34.9 14.2 34.6 12.2 34 10.4 Z"
          fill={`url(#${wing})`}
        />
