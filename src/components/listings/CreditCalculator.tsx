    ...
    <Card withBorder radius="md" p="md" style={{ borderColor: "var(--mantine-color-border)" }}>
      <Stack gap="sm">
        <Group gap="sm" align="center">
          <IconCalculator size={18} color="var(--market-primary)" />
        ...
        <Group justify="space-between" align="center">
          <Stack gap={0}>
            ...
            <Text size="xl" fw={800} c="var(--market-primary)" ff="var(--font-display),sans-serif">{formatPrice(monthlyPayment)}</Text>
          </Stack>
