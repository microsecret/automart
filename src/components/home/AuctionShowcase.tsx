              ...
              <Box className="auction-showcase__media">
                {lot.imageUrl ? (
                  <NextImage
                    ...
                    /* Без заголовка источника: площадки отвергают запросы
                       с чужого сайта и отдают ошибку вместо снимка. На
                       странице аукционов эта политика стояла и фото
                       грузились, на витрине её не было — два лота из
                       восьми оставались пустыми. */
