    ...
    <Paper id="document-builder" withBorder radius="xl" p={{ base: "md", md: "xl" }}>
      <Stack gap="lg">
        <Group gap="sm" align="flex-start" wrap="nowrap">
          ...
          <Stack gap={2}>
            <Text component="h2" fw={800} fz={{ base: "22px", md: "26px" }}>Заполнить и скачать</Text>
        ...
        {/* Мера строки: замер при окне 1920 дал 200 знаков при норме
            чтения 60–75. Это предупреждение о границах шаблона договора —
            его читают внимательно, и длинная строка здесь дороже всего. */}
        <Text size="xs" c="dimmed" maw="var(--measure)">Перед подписанием сверьте сведения с оригиналами документов. Шаблон не учитывает доверенность, долевую собственность, наследство, юридическое лицо и иные особые обстоятельства — для них нужна индивидуальная проверка.</Text>
      </Stack>
    </Paper>
  )
}
